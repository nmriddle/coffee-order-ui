...
const host_remote = "https://coffee-order-latest-lfzd.onrender.com";
...
async function updateTheNavigationBar() {
  const navigation = document.getElementsByClassName("right-align")[0];

  let loginTag = navigation.children[navigation.children.length - 1];
  if (configuration.isLoggedIn()) {
    loginTag.innerHTML = `<a href="login.html">Logout</a>`;
  } else {
